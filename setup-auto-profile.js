...
// Write the SQL file
const outputPath = path.join("./", 'auto_create_profile.sql');
fs.writeFileSync(outputPath, sqlScript, 'utf8');

console.log('✅ SQL script created at:', outputPath);
console.log('\n📋 Next steps:');
console.log('1. Open Supabase Dashboard');
console.log('2. Go to SQL Editor');
console.log('3. Copy and paste the contents of auto_create_profile.sql');
console.log('4. Click "Run" to execute');
console.log('\nThis will:');
console.log('✓ Create profiles table');
console.log('✓ Create user_stats table');
console.log('✓ Set up RLS policies');
console.log('✓ Create trigger for auto-profile creation');
console.log('✓ Backfill profiles for existing users');