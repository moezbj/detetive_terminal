...
import { supabase, getProfile, getUserStats } from "../../supabaseService";
    ...
    <div className="h-screen flex items-center justify-center">
      <div className="max-w-md w-full p-12 bg-neutral-900 border border-white/5 rounded-[2rem] shadow-2xl">
        ...
        <form onSubmit={handleAuth} className="space-y-6">
          <input
            className="w-full bg-black p-4 rounded-xl text-white font-mono text-sm"
            placeholder="EMAIL"
          ...
          />
          <button className="w-full py-4 bg-red-700 text-white font-black rounded-xl uppercase tracking-widest">
            {isLoading
              ? "Validating..."
              : authForm.isLogin
                ? "Login"
        ...
        <button
          ...
          className="w-full mt-4 text-[10px] text-gray-500 uppercase font-black"
        >
          {authForm.isLogin
