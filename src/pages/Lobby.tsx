...
const Lobby: React.FC = () => {
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="p-10 relative -mt-32">
                <div className="flex justify-between items-start mb-4">
                  <span
                    className={`text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded bg-black/80 border ${c.difficulty === "Hard" ? "text-red-500 border-red-500" : "text-yellow-500 border-yellow-500"}`}
                  >
      ...
      {showPaywall && (
        <PaywallModal setShowPaywall={setShowPaywall} />
      )}
    </div>
  );
};
